...
Wave function $\Psi(x,t)$ is normalizable. Expectation value of $\hat{x}$ is \[\expval{\hat{x}}=\int_{-\infty}^{+\infty}\Psi(x,t)\hat{x}\Psi(x,t)\dd{x}=\int_{-\infty}^{+\infty}\Psi(x,t)x\Psi(x,t)\dd{x}\]
...
>>>>>>> de3b972feb613c0c609d571f9ec4c1c6a40d5ebf
\section{Foundations}
